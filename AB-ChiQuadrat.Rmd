...
a) Stellen Sie die Nullhypothese und die Alternativhypothese in Worten auf. 
b) Berechnen Sie die Spalten- und Randsummen für die Häufigkeits-Tabelle. 
c) Erstellen Sie eine Tabelle von Häufigkeiten, die man erwarten würde, wenn
es keinen Unterschied in den Nebenwirkungen zwischen den Antidepressiva gäbe. 
d) Berechnen Sie die Prüfgröße für den $\chi^2$-Unabhängigkeits-Test
e) Treffen Sie eine statistische Entscheidung
