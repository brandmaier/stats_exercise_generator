...
knitr::kable( data.frame(aov1$factor_level_names, aov1$factor_means),
              col.names = c("Bedingung","Mittelwert"), booktabs=TRUE ) %>% kableExtra::kable_styling(latex_options = c("hold_position"))
```
...
```{r}
knitr::kable( data.frame(aov1$factor_level_names, aov1$factor_means),col.names = c("Störung","Mittelwert"), booktabs=TRUE ) %>% kableExtra::kable_styling(latex_options = c("hold_position"))
...
```{r}
knitr::kable( data.frame(aov1$factor_level_names, aov1$factor_means),col.names = c("Zufriedenheit","Mittelwert"), booktabs=TRUE )
```
