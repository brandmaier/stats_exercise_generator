...
knitr::kable(df,caption = "Faktorladungsmatrix" ) %>% kableExtra::kable_styling(latex_options = "hold_position")
```
...
knitr::kable(dfx, caption="Ladungsmatrix mit Kommunalitäten und Eigenwerten") %>% kableExtra::kable_styling(latex_options = "hold_position")
