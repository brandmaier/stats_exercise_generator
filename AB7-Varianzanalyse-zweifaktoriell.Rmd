...
cat("Richtig ist Torte C. Die $QS_B$ ist ungefähr so groß wie die Interaktion. $QS_A$ ist verschwindend klein im Vergleich zum Rest. $QS_inn$ ist um ein Vielfaches größer als die übrigen QS.")
