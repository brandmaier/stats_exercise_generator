...
Berechnen Sie die Schätzer für Regressionskonstante und das Regressionsgewicht aus den Angaben. Was bedeutet das Regressionsgewicht hier inhaltlich?
...
happy <- anz_freunde*0.3+anz_follower*0.5+rnorm(N)
