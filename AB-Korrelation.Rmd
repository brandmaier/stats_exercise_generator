...
Laden Sie die Datensätze "korrelation-beispiel1.csv" und "korrelation-beispiel2.csv". Berechnen Sie eine einfache lineare Regression (oder auch eine bivariate Korrelation) mit einem Statistikprogramm ihrer Wahl (z.B. JASP). Prüfen Sie, ob es einen linearen Zusammenhang je zwischen den beiden Variablen $X$ und $Y$ gibt. Was folgern Sie? Erstellen Sie auch die Streudiagramme. Was kann man daraus erkennen?
