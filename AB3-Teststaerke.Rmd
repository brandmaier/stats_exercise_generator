...
- Welche Schritte sind nötig, um auf Basis dieser Informationen eine Teststärkenanalyse durchzuführen?
...
```{r ls, eval=include_solution, results="asis"}
  solution_header()
cat("Es gibt hier zwei Möglichkeiten für eine Teststärkenanalyse. Festgelegt sind bei der Studie das Signifikanzniveau und die Stichprobengröße. Damit verbleiben zwei freie Größen, nämlich die Stichprobengröße und die Teststärke. Entweder kann man durch Festlegung einer angenommenen Effektstärke die Teststärke schätzen (sog. a-priori Teststärkenanalyse) oder man kann durch Festlegung der Stichprobengröße die detektierbare Effektgröße schätzen (sog. Sensitivitätsanalyse).")

cat("\n\nSenkt man das Signifikanzniveau, sinkt die statistische Teststärke.")
```
